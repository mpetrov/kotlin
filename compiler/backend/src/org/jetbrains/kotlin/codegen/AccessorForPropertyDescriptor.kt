...
open class AccessorForPropertyDescriptor private constructor(
    ...
    override val isForInlineContext: Boolean
    ...
    init {
        ...
        val getterDescriptor =
            if (isWithSyntheticGetterAccessor)
                Getter(this, accessorKind, isForInlineContext)
            else
                calleeDescriptor.getter as PropertyGetterDescriptorImpl?

        val setterDescriptor =
            if (isWithSyntheticSetterAccessor) Setter(this, accessorKind, isForInlineContext) else calleeDescriptor.setter
